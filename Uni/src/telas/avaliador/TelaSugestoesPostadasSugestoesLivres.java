...
public class TelaSugestoesPostadasSugestoesLivres extends JFrame implements ActionListener, MouseListener {
...
JButton bntretornar = new JButton(retorn);	
	...
	public TelaSugestoesPostadasSugestoesLivres(){
		super("Uni - Postadas em Sugestões Livres");
    ...
    bntmeuperfil.setContentAreaFilled(false);//tira o fundo
      ...
      bntretornar.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));		
		...
		lbinfraestrutura = new JLabel("      (Sugestões Livres)");
	...
	public static void PreencherJTable(DefaultTableModel modelo) {
		...
		for(Sugestao s: sugestao.CarregarSugestoesSugestoesLivresAguardando()){
