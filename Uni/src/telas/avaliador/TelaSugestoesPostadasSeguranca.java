...
public class TelaSugestoesPostadasSeguranca extends JFrame implements ActionListener, MouseListener {
...
JButton bntretornar = new JButton(retorn);	
	...
	public TelaSugestoesPostadasSeguranca(){
		super("Uni - Postadas em Segurança");
    ...
    bntmeuperfil.setContentAreaFilled(false);//tira o fundo
      ...
      bntretornar.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));
		...
		lbinfraestrutura = new JLabel("      (Segurança)");
	...
	public static void PreencherJTable(DefaultTableModel modelo) {
		...
		for(Sugestao s: sugestao.CarregarSugestoesSegurancaAguardando()){
