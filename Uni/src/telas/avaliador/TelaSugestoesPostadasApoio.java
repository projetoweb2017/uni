...
public class TelaSugestoesPostadasApoio extends JFrame implements ActionListener, MouseListener {
...
JButton bntretornar = new JButton(retorn);	
	...
	public TelaSugestoesPostadasApoio(){
		super("Uni - Postadas em Apoio");
    ...
    bntmeuperfil.setContentAreaFilled(false);//tira o fundo
      ...
      bntretornar.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));
		...
		lbinfraestrutura = new JLabel("      (Apoio)");
	...
	public static void PreencherJTable(DefaultTableModel modelo) {
		...
		for(Sugestao s: sugestao.CarregarSugestoesApoioAguardando()){
