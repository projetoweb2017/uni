...
public class TelaSugestoesPostadasEventos extends JFrame implements ActionListener, MouseListener {
...
JButton bntretornar = new JButton(retorn);	
	...
	public TelaSugestoesPostadasEventos(){
		super("Uni - Postadas em Eventos");
    ...
    bntmeuperfil.setContentAreaFilled(false);//tira o fundo
      ...
      bntretornar.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));
		...
		lbinfraestrutura = new JLabel("      (Eventos)");
	...
	public static void PreencherJTable(DefaultTableModel modelo) {
		...
		for(Sugestao s: sugestao.CarregarSugestoesEventosAguardando()){
