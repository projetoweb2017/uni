...
public class TelaSugestoesPostadasCursos extends JFrame implements ActionListener, MouseListener {
...
JButton bntretornar = new JButton(retorn);	
	...
	public TelaSugestoesPostadasCursos(){
		super("Uni - Postadas em Cursos");
    ...
    bntmeuperfil.setContentAreaFilled(false);//tira o fundo
      ...
      bntretornar.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));
		...
		lbinfraestrutura = new JLabel("            (Cursos)");
	...
	public static void PreencherJTable(DefaultTableModel modelo) {
		...
		for(Sugestao s: sugestao.CarregarSugestoesCursosAguardando()){
