...
private JLabel lbbrancotop, lbbrancotopp, lbtop, lbtopp;  
	...
	public void actionPerformed(ActionEvent e) {
		...
		this.dispose();
        new telas.superior.TelaInfraestrutura().setVisible(true);  
		}
		
		if (e.getSource() == bnteventos) {
		this.dispose();
        new telas.superior.TelaEventos().setVisible(true);  
		}
		
		if (e.getSource() == bntcursos) {
		this.dispose();
        new telas.superior.TelaCursos().setVisible(true);  
		}
		
		if (e.getSource() == bntapoio) {
		this.dispose();
        new telas.superior.TelaApoio().setVisible(true);  
		}
		
		if (e.getSource() == bntseguranca) {
		this.dispose();
        new telas.superior.TelaSeguranca().setVisible(true);  
		}
		
		if (e.getSource() == bntsugestoeslivres) {
		this.dispose();
        new telas.superior.TelaSugestoesLivres().setVisible(true);  
		}
