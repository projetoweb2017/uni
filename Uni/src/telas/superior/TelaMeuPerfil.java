...
//private static final String[] cur = {"","Analise e desenvolvimento de sistemas","Banco de dados","Gestão da tecnologia da informação ","Redes de computadores","Sistema da informação","Jogos digitais"};
