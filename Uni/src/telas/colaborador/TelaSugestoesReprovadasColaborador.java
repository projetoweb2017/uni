...
// Sugestão usada com o Status é reprovado - 3
public class TelaSugestoesReprovadasColaborador extends JFrame implements ActionListener {
...
JButton bntretornar = new JButton(retorn);	
	...
	public TelaSugestoesReprovadasColaborador(){
		super("Uni - Sugestão Reprovada");
    ...
    bntmeuperfil.setContentAreaFilled(false);//tira o fundo
      ...
      //labels
        ...
        lblsugestaot = new JLabel("             Sugestão Reprovada");   
