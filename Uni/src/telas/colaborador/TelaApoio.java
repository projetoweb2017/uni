...
public class TelaApoio extends JFrame implements ActionListener, MouseListener {
//imagen menu
...
private JLabel lbbrancotop, lbbrancotopp, lbtop, lbtopp;
   ...
   private JScrollPane barraRolagem;
	...
	public static void PreencherJTable(DefaultTableModel modelo) {
		...
		for(Sugestao s: sugestao.CarregarSugestoesApoioAprovadas()){
