...
private JLabel lbbrancotop, lbbrancotopp, lbtop, lbtopp;     
	...
	public TelaPrincipal(){
      ...
      bntsair.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));
       ...
       // top sugestão
        ...
        espaco.setFont(new Font("Arial", 1, 27)); 
       ...
       espaco.setPreferredSize(new Dimension(170,150));
        ...
        jPanelCategorias.setBackground(new Color(255,255,255));
       ...
       // lbcategorias.setPreferredSize(new Dimension(471,70));
        ...
        //bntTop.setPreferredSize(new Dimension(160,120));//tamanho do bota0
	...
	public void actionPerformed(ActionEvent e) {
		...
		this.dispose();
        new telas.colaborador.TelaInfraestrutura().setVisible(true);  
		}
		
		if (e.getSource() == bnteventos) {
		this.dispose();
        new telas.colaborador.TelaEventos().setVisible(true);  
		}
		
		if (e.getSource() == bntcursos) {
		this.dispose();
        new telas.colaborador.TelaCursos().setVisible(true);  
		}
		
		if (e.getSource() == bntapoio) {
		this.dispose();
        new telas.colaborador.TelaApoio().setVisible(true);  
		}
		
		if (e.getSource() == bntseguranca) {
		this.dispose();
        new telas.colaborador.TelaSeguranca().setVisible(true);  
		}
		
		if (e.getSource() == bntsugestoeslivres) {
		this.dispose();
        new telas.colaborador.TelaSugestoesLivres().setVisible(true);  
		}
		if (e.getSource() == bntTop) {
		this.dispose();
        new telas.colaborador.TelaTop().setVisible(true);  
		}
	}
}
