...
public class TelaSugestoesLivres extends JFrame implements ActionListener, MouseListener {
...
private JLabel lbbrancotop, lbbrancotopp, lbtop, lbtopp;
	...
	private JLabel lbcategorias,lbcategoria,lbbranco,lbbrancoo,espaco;
	
	private JButton bntnovasugestaomini;
   ...
   private JScrollPane barraRolagem;
	...
	public TelaSugestoesLivres(){
		super("Uni - Sugestões Livres");
		...
		bntnovasugestaomini = new JButton("Nova Sugestão");
    ...
    bntmeuperfil.setContentAreaFilled(false);//tira o fundo
      ...
      bntTop.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));
		...
		lbcategoria = new JLabel("(Sugestões Livres)             ");
      ...
      bntretornar.setPreferredSize(new Dimension(140,80));//tamanho do bota0
        ...
        jPanelSugestoes.add(bntnovasugestaomini);
		...
		bntnovasugestaomini.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == bntnovasugestaomini) {
			this.dispose();
			new telas.colaborador.TelaNovaSugestao().setVisible(true);  
		}
	...
	public static void PreencherJTable(DefaultTableModel modelo) {
		...
		for(Sugestao s: sugestao.CarregarSugestoesSugestoesLivresAprovadas()){
